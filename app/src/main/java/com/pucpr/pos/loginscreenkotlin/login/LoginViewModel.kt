package com.pucpr.pos.loginscreenkotlin.login
...
import com.pucpr.pos.loginscreenkotlin.repository.AuthRepository
...
class LoginViewModel(
    ...
    fun onConfirmPassowrdSignUpChange(confirmPasswordSignUp:String) {
    ...
    fun loginUser(context:Context) = viewModelScope.launch {
        try {
            ...
            repository.loginUser(loginUiState.userName, loginUiState.password) {
                    isSuccesfull ->
                if (isSuccesfull) {
                    Toast.makeText(
                        context,
